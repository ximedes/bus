...
void loop()
{
    ...
    newValue = oldValue + int(k_val * (position - oldValue));

    Serial.print(oldValue);
    Serial.print('\t');
    Serial.print(position);
    Serial.print('\t');
    Serial.print(position - oldValue);
    Serial.print('\t');
    Serial.print(newValue);
    Serial.print('\t');

    Serial.println(int(k_val * (position - oldValue)));
    oldValue = newValue;
    ...
    myservo.write(newValue / 40);
    analogWrite(11, newValue / 40);
    delay(25);
}
